...
bool CFrameGrabber::grabFrame(CBitmap* bitmap, int skiplines)
{
    ...
    //
	if (m_stb.stb_type == BRCM7439 || m_stb.stb_type == BRCM73625 || m_stb.stb_type == BRCM7376 || m_stb.stb_type == BRCM7251s || m_stb.stb_type == BRCM7252s || m_stb.stb_type == BRCM7444s) {
		// Parameter for ARM
