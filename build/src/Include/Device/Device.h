...
class CMainLoop; //forward declaration
...
class CChannel
{
  public:
    ...
    void SetValues(float speed, float value, float gamma, float blacklevel) { m_speed = speed; m_gamma = gamma; m_wantedvalue = value; m_blacklevel = blacklevel;}
